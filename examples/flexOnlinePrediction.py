""" Online prediction with flexible git model defintion """
...
if __name__ == "__main__":
    ...
    credentials = dict(username="root", password="omero", serverUrl="ibt056")
    ...
    model = FlexibleOnlineModel(
        "http://ibt056/segService/batch-image-prediction/",
        model_desc,
        batch_size=10 + 1,
    )
