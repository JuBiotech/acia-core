...
def postprocess(output_data, model, offset_x=0, offset_y=0, contours=False):
    ...
    output_contours = (segm_result != None) and contours
...
if __name__ == '__main__':
    ...
    print('Loading model...')
    # init a detector
    model = init_detector(config_file, path, device=device, cfg_options={'test_cfg.rpn.nms_thr': 0.7,
