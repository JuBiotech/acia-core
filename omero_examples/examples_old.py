...
def add_roi_to_image(conn, imageId: int, z: int = 0, t: int = 0):
    ...
    from .shapeUtils import create_ellipse, create_polygon, create_rectangle
...
with BlitzGateway(username, password, host="ibtomero", port=4064) as conn:
    print_user_info(conn)
    #list_projects(conn)
